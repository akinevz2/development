...
1. Gather context yourself first: read the feature request, the relevant source files, and any project conventions (AGENTS.md, memos).
...
- The analyst complements the `delegate` skill: analyst first for design, delegate for the local-LLM implementation steps.
